...
public class comp 
{
    [MenuItem("Assets/Create/Laverinto/CódigoIZI", false, 80)]
    public static void CrearScript()
    {
        ...
        string filePath = Path.Combine(path, "CódigoIZI.cs");

        string contenido = @"using UnityEngine;
                            using System.Collections.Generic;

public class CódigoIZI : MonoBehaviour
{
